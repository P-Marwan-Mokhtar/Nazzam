...
(function () {
  try {
    ...
    // بنعلّم إن التاب ده دخل التطبيق — اللاندينج ترجّعه تلقائيًا فقط لو
    // فيه جلسة حقيقية (تلميح nazam-has-session)، لا بالعلم وحده، عشان
    // من لم يدخل أو من خرج يفضل حرًا في التنقل بين اللاندينج والتطبيق.
