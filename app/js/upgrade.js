...
//
// التصميم: قائمة المميزات + Dropdown للدورة (شهري/سنوي) + الدفع الآمن (Polar)
// + زر اشتراك بالسعر — بلا بطاقة مجانية هنا (المجانية تُدار تلقائيًا).
// زر الاشتراك ينادي polar-checkout ويحوّل لصفحة Polar المستضافة؛
// التفعيل يحدث حصرًا عبر polar-webhook (السيرفر مصدر الحقيقة).
// ============================================================
...
// Polar، ويحوّل لصفحة الدفع — بلا أي تفعيل محلي (التفعيل عبر الويبهوك حصرًا).
